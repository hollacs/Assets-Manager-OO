...
Then, when a player uses the knife to hit a wall, it will make a shockwave (sprite) and an explosion (sound), Otherwise, when the player hits nothing, it plays a hostage sound (generic).
